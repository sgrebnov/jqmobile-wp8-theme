...
(function ($) {
    ...
    //remover, adder,
    $.addTheme = function (themeId, updateCssLink, activePage) {
       ...
       activePage = activePage || $.mobile.activePage;
        ...
        $(activePage).find('.ui-li-divider').each(function (index, obj) {
        ...
        $(activePage).find('.ui-body-a, .ui-body-b, .ui-body-c, .ui-body-d, .ui-body-e').removeClass('ui-body-a ui-body-b ui-body-c ui-body-d ui-body-e')
            .addClass('ui-body-' + theme)
            .attr('data-theme', theme);
    ...
    $(document).ready(function () {
        ...
        $(document).bind('pagebeforeshow',function(event, ui){
            $.addTheme(window.themeId, false, event.target);
        });
